...
namespace ChatClient.Message
{
    ...
    public class CurrentUserChangeMessage: ValueChangedMessage<ClientData>
    {
        public CurrentUserChangeMessage(ClientData value) : base(value)
        {
        }
    }
