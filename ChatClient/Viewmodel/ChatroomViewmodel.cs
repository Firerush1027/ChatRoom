...
namespace ChatClient.Viewmodel
{
    public class ChatroomViewmodel : ViewModelBase
    {
        public ChatroomViewmodel()
        {
            ...
            Messenger.Register<ChatroomViewmodel, CurrentUserChangeMessage>(this, (r, m) =>
            {
                ChatroomViewmodel.CurrentUser = m.Value;
                if (m.Value == null)
                    MessageList.Clear();
            });
        }
        ...
        public static ClientData CurrentUser;
    }
    ...
    public class MessageDataViewmodel : ViewModelBase
    {
        public MessageDataViewmodel(MessageData Data)
        {
            ...
            //Messenger.Register<MessageDataViewmodel, CurrentUserChangeMessage>(this, (r, m) => r.CurrentUser = m.Value);
        }
        ...
        public ClientData CurrentUser { get; set; }
    }
}